...
from app.cores.tools import city_facts_tool, time_tool, weather_tool
...
class CityAssistantAgent:
    ...
    @staticmethod
    async def on_handoff(ctx: RunContextWrapper[None], input_data: HandoffInfo) -> None:
        """
    ...
    def _build_orchestration_agent(self) -> Agent:
        ...
        - If the user wants advice, discussion, or planning for a trip,
        always delegate to the Trip discussion agent.
